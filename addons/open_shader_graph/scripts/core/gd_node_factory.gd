...
static func _initialize() -> void:
	...
	for category in categories:
		var category_path: String = nodes_base_path + "/" + category
...
static func _discover_categories(nodes_base_path: String) -> Array:
	...
	if not dir:
		push_warning("NodeFactory: Cannot access nodes base path: " + nodes_base_path)
		return categories
...
static func _scan_category_folder(category: String, folder_path: String, excluded_files: Array) -> void:
	var dir := DirAccess.open(folder_path)
	if not dir:
		push_warning("NodeFactory: Cannot access category folder: " + folder_path)
		return
...
static func _register_node_from_file(category: String, script_path: String) -> void:
	...
	if temp_node.has_method("get") and temp_node.get("title"):
		...
		var node_path: String = temp_node.get("node_path")
...
static func register_node(category: String, node_name: String, script_path: String) -> void:
	_initialize()
